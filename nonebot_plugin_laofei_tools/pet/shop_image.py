...
HELP_ITEMS = [
    ...
    ("宠物排行榜 [武力/幸运]", "展示宠物等级/武力/幸运 TOP10"),
    ("宠物背包", "查看道具背包"),
    ("宠物弃养", "弃养宠物（需二次确认）"),
    ("宠物帮助", "查看本帮助信息"),
]
...
FISHING_HELP_ITEMS = [
    ("钓鱼", "消耗10体力抛竿钓鱼，每日限15次，稀有度越高等待越久"),
    ("快速钓鱼", "自动钓鱼至体力/次数耗尽，无延迟，合并转发结果"),
    ("钓鱼图鉴 / 鱼图鉴", "查看全部36种鱼的收集进度"),
    ("钓鱼箱 / 鱼箱", "查看已钓到的鱼，可进行售卖"),
    ("钓鱼出售全部", "一键出售鱼箱所有鱼"),
    ("钓鱼出售 <鱼名> <数量>", "指定数量出售，如「钓鱼出售 鲤鱼 5」"),
    ("钓鱼出售 <鱼名1> <鱼名2>", "多品种各卖1条，如「钓鱼出售 鲤鱼 鲫鱼」"),
    ("钓鱼帮助 / 鱼帮助", "查看本帮助信息"),
]
...
def generate_fishing_help_image() -> str:
    ...
    # 稀有度说明
    tip = "稀有度：💎稀世罕见(1%)  ✨超级稀有(4%)  ⭐稀有(20%)  普通(50%)  🗑️杂物(25%)"
